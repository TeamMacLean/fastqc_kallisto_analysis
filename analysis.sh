...
function kallisto(){
	sbatch --mem 10G -o results/$1/${3}_kallisto.log  -J $3 -n 2 --wrap "source kallisto-0.43.1; kallisto quant -i /hpc-home/dingp/kallisto_Ram/AtRTDv2_QUASI_kallisto_index_v2  -o results/$1/${3}_kallisto -b 100 --single -l 170 -s 10 $2"
}
